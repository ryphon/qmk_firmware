...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_A,        KC_S, KC_D, KC_F, KC_G, KC_H,   KC_J, KC_K, KC_L, KC_ENT,  TG(1),
  ...
  /* Level 1: Numbers Layer
     ...
     */
  [1] = LAYOUT(
    KC_ESC,  KC_KP_7, KC_KP_8, KC_KP_9, KC_F5, KC_ASTR, KC_DOT,  KC_COMM, KC_LPRN, KC_RPRN, KC_DEL,
    KC_TAB,  KC_KP_4, KC_KP_5, KC_KP_6, KC_MINS, KC_PLUS, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,
    KC_LALT, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_0,             KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_RSFT
  ),
