...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
   * | Ctrl |  Win |  ADJ |  Win | Alt  | Space| DEL  |  | Enter| Space|  FN  | Prev |Pause | Next | Ctrl |
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------'
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LGUI,     ADJ, KC_LGUI, KC_LALT,  KC_SPC,  KC_DEL,  KC_ENT,  KC_SPC,      FN, KC_MPRV, KC_MPLY, KC_MNXT, KC_RCTL, \
